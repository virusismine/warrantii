...
class PrincipalclassController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		$pagination->setPath('principalclass');
		...
		return view('principalclass.index',$this->data);
	}	
