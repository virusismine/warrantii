...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                button: '<button type="button" background-color: red; class="multiselect dropdown-toggle" data-toggle="dropdown"></button>',
                ul: '<ul class="multiselect-container dropdown-menu"></ul>',
                filter: '<li class="multiselect-item filter"><div class="input-group"><input class="virus " type="text"></div></li>',
               // filterClearBtn: '<button class="btn btn-default multiselect-clear-filter" type="button"></button>',
