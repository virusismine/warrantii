...
<!--<h3> {{ $pageTitle }} <small>{{ $pageNote }}</small></h3>-->
          ...
          <a href="{{ URL::to('salespartner/create') }}" class="tips icon-btn index-page" title="Add"><img src="{{ asset('sximo/images/icons/add.png')}}" /></a>
      ...
      <div class="sbox-content"> 	
        ...
        {!! Form::open(array('url'=>'salespartner/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
...
<input type="hidden" id="page_type" name="page_type" value="SALES">
            ...
            "columns": [
                ...
                render: function (data) {
                    var items = data.split(',');
                       return '<a href='+ 'salespartner' + '/' + items[1] + '>' + items[0] + '</a>';
                }
                },
                {"data": "3"},
                {"data": "4"},
