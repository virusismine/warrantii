...
<div class="sbox animated fadeInRight">
	<div class="sbox-title">
     ...
     <a href="{{ URL::to('orglocation') }}" class="tips icon-btn edit-page" title="Cancel"><img src="{{ asset('sximo/images/icons/back.png')}}"  /></a>
     ...
     <div class="col-md-12 min-scroll"><br>
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">      
                 <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    <input type="text" class="form-control LOCATION_NAME" id="LOCATION_NAME" name="LOCATION_NAME" value="{{$location[0]->LOCATION_NAME}}" >
                  </div> 
                  <div class="col-md-2"></div>
                </div>
               <div class="form-group">
                 <div class="col-md-2"></div>
                  <div class="col-md-8">
                    ...
                    <input type="text" class="form-control LOCATION_CODE" id="LOCATION_CODE" name="LOCATION_CODE" value="{{$location[0]->LOCATION_CODE}}" >
                  </div> 
                  <div class="col-md-2"></div>
                </div>
               ...
               {!! Form::select('LOCATION_TYPE', array(''=>'--Select--', 'O'=>'Office','P'=>'Plant','M'=>'Market','D'=>'Depot'),array('value'=>$location[0]->LOCATION_TYPE),array('class' => 'form-control LOCATION_TYPE')) !!}
                  </div> 
                  <div class="col-md-2"></div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    <input type="text" class="form-control ADDRESS" id="ADDRESS" name="ADDRESS" value="{{$location[0]->ADDRESS}}" >
                  </div> 
                  <div class="col-md-2"></div>
                </div>                
            </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">      
                <div class="form-group">
                  ...
                  {!! Form::select('CITY',array(''=>'Select City')+$city,  array('value'=>$location[0]->CITY), array('class' => 'form-control CITY','id'=>'CITY')) !!}
                  </div> 
                  <div class="col-md-2"></div>
                </div>       
           ...
           {!! Form::select('STATE',array(''=>'Select State')+$state,  array('value'=>$location[0]->STATE), array('class' => 'form-control STATE','id'=>'STATE')) !!}
                  </div> 
                  <div class="col-md-2"></div>
                </div>               
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    {!! Form::select('COUNTRY',array('99'=>'India')+$country, array('value'=>$location[0]->COUNTRY), array('class' => 'form-control COUNTRY','id'=>'COUNTRY')) !!}
                  </div> 
                  <div class="col-md-2"></div>
                </div>   
