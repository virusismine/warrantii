...
<!--<h3> {{ $pageTitle }} <small>{{ $pageNote }}</small></h3>-->
          ...
          <a href="{{ URL::to('orgloaction/create') }}" class="tips icon-btn index-page" title="Add"><img src="{{ asset('sximo/images/icons/add.png')}}" /></a>
       ...
       <div class="pop-up pop_up_box">
        ...
        <div class="col-md-12 cln-padding">
            ...
            <div class="col-md-7 no-padding">
            {!! Form::select('LOCATION_TYPE', array(''=>'Select', 'O'=>'Office','P'=>'Plant','M'=>'Market','D'=>'Depot'),Input::old('LOCATION_TYPE'),array('class' => 'form-control LOCATION_TYPE','id' => 'LOCATION_TYPE', 'required')) !!}                     
            </div>
            </div>     
        </div>
      ...
      <div class="sbox-content"> 	
        ...
        {!! Form::open(array('url'=>'principalusers/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
