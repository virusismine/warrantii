...
<!--<h3> {{ $pageTitle }} <small>{{ $pageNote }}</small></h3>-->
          ...
          <a href="{{ URL::to('brand/create') }}" class="tips icon-btn index-page" title="Add"><img src="{{ asset('sximo/images/icons/add.png')}}" /></a>
        ...
        <div class="col-md-12 cln-padding">
            <div class="form-group">
            <label for="BRAND_NAME" class=" control-label col-md-5 no-padding text-left">Brand Name</label>
            <div class="col-md-7 no-padding">
                <input type="text" id="BRAND_NAME" class="form-control BRAND_NAME" required="" name="BRAND_NAME" >                     
            </div>
            </div>     
        </div>
        ...
        <div class="col-md-12 cln-padding">
            <div class="form-group">
                ...
                <button type="button" class="tips btn btn-sm btn-primary" onclick="searchbrand()">Search</button>                           
                </div>
            </div>     
        </div> 
        </form>
      ...
      <div class="sbox-content"> 	
        ...
        {!! Form::open(array('url'=>'brand/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
...
//            },
            ...
            "columns": [
                ...
                render: function (data) {
                       return '<a href='+ 'brand' + '/' + data + '>' + data + '</a>';
                }
                },
                {"data": "3"},
                {data: "4",
