...
<div class="page-content row">	
  <div class="page-content-wrapper">
    ...
    <div class="sbox animated fadeInRight">
      <div class="sbox-title">
        ...
        <a href="{{ URL::to('brand') }}" class="tips icon-btn edit-page" title="Cancel"><img src="{{ asset('sximo/images/icons/back.png')}}" /></a>
  ...
  @endif
       ...
       {!! Form::model($brand,array('route' => array('brand.update', $brand[0]->BRAND_CODE),'class'=>'form-horizontal','id'=>'resource1', 'method'=>'PUT','files' => true ,'parsley-validate'=>'','novalidate'=>' ')) !!}      
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            ...
                            <input type="text" id="BRAND_NAME " class="form-control BRAND_NAME" name="BRAND_NAME" value="{{$brand[0]->BRAND_NAME}}" placeholder= "" required > 
                          </div>
                          <div class="col-md-4"></div>
                        </div>
                    </div>
