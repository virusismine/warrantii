...
<div class="page-content row">	
  <div class="page-content-wrapper">
    ...
    <div class="sbox animated fadeInRight">
      ...
      <a href="{{ URL::to('servicepartner/'.$servicepartner->PARTNER_ID.'/edit')}}" class="tips icon-btn show-page" title="Edit"><img src="{{ asset('sximo/images/icons/edit.png')}}"  /></a>
  ...
  {!! Form::model($servicepartner,array('route' => array('servicepartner.update', $servicepartner->PARTNER_ID),'class'=>'form-horizontal','id'=>'resource1', 'method'=>'PUT','files' => true ,'novalidate'=>' ')) !!}      
