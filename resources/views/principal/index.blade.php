...
<div class="sbox animated fadeInRight">
	<div class="sbox-title">
        ...
        <a href="{{ URL::to('principal/create') }}" class="tips icon-btn index-page" title="Add"><img src="{{ asset('sximo/images/icons/add.png')}}" /></a>
	...
	<div class="sbox-content"> 	
	  <div class="pop-up pop_up_box">
        ...
        <div class="form-group">
            <label for="PRINCIPAL_CODE" class=" control-label col-md-5 no-padding text-left">Principal Code</label>
        ...
        <div class="col-md-12 cln-padding">
            <div class="form-group">
            <label for="PRINCIPAL_NAME" class=" control-label col-md-5 no-padding text-left">Principal Name</label>
            <div class="col-md-7 no-padding">
	 ...
	 {!! Form::open(array('url'=>'principal/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
            ...
            "columns": [
                ...
                render: function (data) {
                    var items = data.split(',');
                       return '<a href='+ 'principal' + '/' + items[1] + '>' + items[0] + '</a>';
                }
                },
                {"data": "3"},
                {"data": "4"},
