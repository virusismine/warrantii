    ...
    <div class="sbox animated fadeInRight">
      <div class="sbox-title">
        ...
        <div class="sbox-tools" >
          ...
          <a href="{{ URL::to('category/download') }}" class="tips btn btn-sm btn-white" title="{{ Lang::get('core.btn_download') }}">
...
<!--<h3> {{ $pageTitle }} <small>{{ $pageNote }}</small></h3>-->
          ...
          <a href="{{ URL::to('category/create') }}" class="tips icon-btn index-page" title="Add"><img src="{{ asset('sximo/images/icons/add.png')}}" /></a>
